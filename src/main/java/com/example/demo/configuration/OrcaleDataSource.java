...
@Configuration
@MapperScan(basePackages = "com.example.demo.oracleMapper", sqlSessionTemplateRef  = "orcaleSqlSessionTemplate")
public class OrcaleDataSource {
    ...
    public SqlSessionFactory primarySqlSessionFactory(@Qualifier("orcaleDataSources") DataSource dataSource)
        ...
        bean.setMapperLocations(new PathMatchingResourcePatternResolver().getResources("classpath:oracleMapper/*.xml"));
